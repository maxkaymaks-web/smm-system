...
5. `projects/{ProjectID}/voice.md` + `context.md` + `overrides.md` — голос,
   контекст и **накопленный свод правил клиента** (секция «Накопленные правила»
   в `overrides.md` — как клиент любит, выросло из прошлых правок; см. правило
   «Фиксация правок клиента» в `global/rules.md`)
