...
Обе модели уже подключены в LiteLLM-роутере на `5.2.66.188:4000` под виртуальным ключом `smm/*` (трекинг бюджета SMM-проекта отдельно от остального).
