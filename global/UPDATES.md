...
## 04.08.2026 — Новый клиент: Sofia / ЭНЖЕ Стоматология
- Заведён проект `projects/Sofia/` — премиальная семейная стоматология, Казань, @enge_stomatology
- SMM-агент: София Белаш. 16 200 подписчиков, ER 0.07% → цель 30–45 лидов/неделю
- Конкуренты: @yourclinic.ru (174K), @inwhite.medical (49.5K), @prismatica.clinic (13K)
- Полный analytics-pipeline: Apify 77 Reels → медианный анализ → топ-5 референсов → fal.ai видеоанализ
- Написаны 15 сценариев Reels: 5 детских/родители + 5 эстетика/девушки + 5 взрослые/все сегменты
- Форматы: POV, скетч, тир-лист, антипаттерн, talking head, история пациента
- Артефакты: `projects/Sofia/posts/drafts/2026-08-04-reels-{1–15}/` — script.md + scenario.html + scenario.pdf
- ⚠️ Нужно уточнить у Софии: реальные цены (виниры, отбеливание, имплант), TG-канал, цвета клиники

---

## 04.08.2026 — Новый клиент: LIPS base (танцевальные курсы)
- Заведён проект `projects/LIPS_BASE/` — отдельный от `projects/LIPS/` (event-коммьюнити)
- Ниша: танцевальные курсы. ЦА — девушки 18–22. Цель — привлечение учеников
- Возможности съёмки: одна девушка-педагог + актёр, есть озвучка
- Конкуренты (от клиента): @rishow_ballet (медиана 5 092 просм), @yurasovateam (медиана 13 485 просм)
- Проведён полный analytics-pipeline: Apify → статистика → fal.ai анализ топ-5 роликов
- Ключевая незанятая ниша: «до и после» ученицы — конкуренты показывают только профессионалов
- Написано 5 сценариев Reels: relatable / идентичность / трансформация / образовательный / оффер
- PDF: `projects/LIPS_BASE/posts/drafts/2026-08-04-reels-{1-5}/scenario.pdf`

---

## 30.07.2026 — Новый клиент: Комфорт Сервис (роллетные шкафы для паркинга)
- Заведён проект `projects/KomfortService/` из устного брифа (30.07.2026)
- Ниша: роллетные шкафы для паркинга. ЦА — люди 30–35+ с подземным паркингом или частным домом (НН)
- Соцсети: Instagram (запускается с нуля). Цель — подписчики и охват
- Конкурент (указал клиент): @shkaf.master (смежная ниша, шкафы)
- Референс: @shkaf.master (анализ по аналогии ниши, без Apify — клиент не дал идей)
- Сценарий Reels #1: «У тебя есть паркинг — а шины всё равно на балконе?» — образовательный/провокация, 20–22 сек, актёр + нарезка, CTA «пиши ШКАФ в директ»
- PDF: `projects/KomfortService/posts/drafts/2026-07-30-reels-1/scenario.pdf`

---

## 29.07.2026 — Новый клиент: КАКСВОИМ балконы и окна
- Заведён проект `projects/KakSvoyim/` из устного брифа (29.07.2026)
- Ниша: отделка и остекление балконов. ЦА — женщина 35–55, однушка/студия, хочет функциональный балкон
- Соцсети: Instagram (handle уточнить у клиента). Цель — лиды, продажи
- Конкуренты (клиент не указал — подобраны агентством): @okna_balkon_spb (медиана 719), @woodbalkon (1 421), @bpbalkon (978), @horbalkon (254)
- Референс: @bpbalkon / CtCfV62ABCq (2 017 просм., ratio 3.1x) — хук «маленький балкон», проблема→решение→эмоция→CTA
- Сценарий Reels #1: «Что делать, если балкон в однушке просто пустует?» — трансформация, 3 функциональные зоны, голосовой скрипт, CTA «пришлите фото»
- PDF: `projects/KakSvoyim/posts/drafts/2026-07-29-reels-1/scenario.pdf`

---

## 27.07.2026 — Новый клиент: Танцевальное коммьюнити LIPS
- Заведён проект `projects/LIPS/` из устного брифа (27.07.2026)
- Ниша: организация мероприятий, артисты, dance community. ЦА — бренды и event-агентства
- Соцсети: Instagram (handle уточнить у клиента). Цель — рост аккаунта, спонсоры/реклама
- Референсы от клиента: 4 Reels + аккаунт @dashtolc. Проанализированы через fal.ai.
- Референс выбран: @dashtolc / DbIX1_GIubJ (мифы о работе в шоу) — паттерн раскрытия деятельности через юмор
- Сценарий Reels #1: «3 мифа о работе в танцевальном шоу» — два артиста в образе, 3 мифа которые слышат бренды/event-агентства
- PDF: `projects/LIPS/posts/drafts/27_07_2026-reels-1/scenario.pdf`

---

## 23.07.2026 — Новый клиент: Финансовая психология | Ольга Кирилишина
- Заведён проект `projects/OlgaKirilishina/` из брифа (ID 2477585348, 2026-07-23 15:00)
- Ниша: финансовая психология, онлайн, русскоязычная ЦА (женщины 27–45, предприниматели с финансовым потолком)
- Соцсети: TikTok @olgakirilishina, Instagram @olga_kirilishina. Цель — TG-подписчики → продажа консультаций
- Конкуренты клиент не указала — подобраны агентством: @raya_nadirova (277K), @kydryashova_kate (12K), @elena._saevich (6K)
- Референс: @raya_nadirova / DbFk1eeq-AA (5K, 2.6x ratio) — паттерн «стучимся в закрытые двери → дверь заперта с нашей стороны»
- Сценарий Reels #1 тип Мотивация: Ольга за рабочим столом → усталость → осознание → «потолок — не снаружи, он внутри»
- PDF: `projects/OlgaKirilishina/posts/drafts/23_07_2026-reels-1/scenario.pdf`

---

## 19.07.2026 — Новый клиент: Студия красоты Marie Meché (парикмахерская, Instagram, СПб)
- Заведён проект `projects/MarieMeche/` из брифа (ID 2474339128, 2026-07-19)
- Контент: продающий, ЦА девушки 25-50, средний чек 10K, приоритет — парикмахерская
- Конкуренты (подобрал оператор сам): @makeupcultura (медиана 8.8K), @haidi.beauty (10.6K), @bizu_beautysalon (2.4K), @fashionchampagne_ (9.6K)
- Топ: @makeupcultura / DZDDF7Yv9uZ (786K, 89x ratio) — трансформация волос + «Красотка»
- Сценарий Reels #1: influencer collab — визажист с женской аудиторией приходит на блонд, озвучивает страх ЦА («сожгут волосы»), показывает процесс + нативно рекомендует студию
- PDF: `projects/MarieMeche/posts/drafts/19_07_2026-reels-1/scenario.pdf`
- Лайфхак: перед сценарием спрашивать «есть ли у заказчика конкретная идея / партнёр для съёмки» — первый вариант переделан из-за голосового

---

## 18.07.2026 — Новый клиент: RentCarHub (@rent.car.hub, аренда авто, Краснодар)
- Заведён проект `projects/RentCarHub/` из брифа (ID 2473576142, 2026-07-17)
- Контент: развлекательный формат, рост подписчиков. Без продаж в явном виде — аренда авто.
- Конкуренты: @luxar_autorent (медиана 3.6K), @sk_rentacar_kg (4.3K), @nd_rentacar.kg (39K), @moscowdreamcars.ru (7.7K)
- Референс: @nd_rentacar.kg / DLVHEkiizSv (1.5M, 38.9x ratio) — прямое обращение к ЦА, слова по одному, закрытие болей, простой продакшн
- Сценарий Reels #1: «Нужна машина на выходные?» — вирусный, 20–23 сек, прямой диалог с ЦА + CTA в директ
- PDF: `projects/RentCarHub/posts/drafts/18_07_2026-reels-1/scenario.pdf`

---

## 16.07.2026 — Новый клиент: Proxodim1mo (@proxodim1mo, спорт/мотивация/дисциплина, Россия)
- Заведён проект `projects/Proxodim1mo/` из брифа (ID 2471490994, 2026-07-15)
- Контент: уличные тренировки + зал, мотивация, дисциплина. Ничего не продаёт — рост аудитории.
- Конкуренты: @vladimirshmondenko (31 видео, медиана 15M), @superbiceps (33 видео, медиана 5.8K), @therealsamgarro (17 видео, медиана 62K)
- Референс: @therealsamgarro / DXyiYccosBJ (498K, 9.5x ratio) — атлет на спортплощадке + провокационный текстовый твист, 6 сек, без речи
- Сценарий Reels #1: «Ты не пропустил тренировку» + *«Ты просто снова перенёс её на завтра»* — тип Вирусный, 6–8 сек
- PDF: `projects/Proxodim1mo/posts/drafts/16_07_2026-reels-1/scenario.pdf`
- Лайфхак сессии: fal.ai CDN URL Instagram + JS SDK → работает; Python queue status даёт 405 → использовать только JS SDK

---

## 09.07.2026 — Новый клиент: Мартинцова (@martincova.17, лайф-контент, СПб)
- Заведён проект `projects/Martincova/` из брифа (ID 2466487634)
- Чувствительный контекст: утрата дочери (онкология, янв. 2026), благотворительный фонд, контент семейный — мама + сын, мягкий юмор, советы для мам 18–50
- Конкуренты: 5 аккаунтов от клиента → выбрано 3 (@nadin_serovski 9M, @v.geshaa 146K, @omelnitskayaa 129K). @sofia_stuzhuk исключена — умерла от онкологии, неуместно
- Референс: @v.geshaa DZuhUjiIgyn (5.27M, 85.5x ratio) — без музыки, чистый диалог, семейный абсурд + реакция
- Сценарий Reels #1: «С завтра мы бегаем в 6 утра. Реакция сына 😂» — мама объявляет пробежки, сын скептичен, пуанта: утром встал сын, мама спит. Самоирония под TOV клиента
- PDF: `projects/Martincova/posts/drafts/09_07_2026-reels-1/scenario.pdf`
...
- Пайплайн: yt-dlp субтитры YouTube конкурентов → Apify 3 Instagram-аккаунта → ratio > 2x → топ-5 → свежие URL → ffmpeg сжатие > 15MB → fal.ai анализ → сценарий Reels #1 + PDF
- @electronik.nikita (чистая электрика Москва) набирает 723K на ролике формата «смета объекта» — сильнейший паттерн для ниши
- Сценарий: хук «Я кайфую от таких объектов» + дифференциатор ЭЛЕМОНТ (испытания после монтажа по регламенту) + CTA на смету в закреплённом

---

## 2026-07-05 — Память между сессиями: очередь в Notion + журнал проекта
Разобрали жалобу оператора «Клод забывает, какой пост следующий». Корень — не
«нет памяти», а очередь постов не читалась из Notion, и статусы не двигались
(у одного проекта все 12 постов висели `черновик` → «следующий» невычислим).
Клод stateless — план из чата он **не запоминает**, он его читает из Notion.
- **Новое жёсткое правило старта:** задача про посты → до работы прочитать очередь
  из Notion (база «Посты», сортировка по `Дедлайн`) и показать «следующий = X».
  Диктуют план в чат — не «запомнил», а **занести в Notion**. Статус двигать
...
## 2026-07-01 (2) — Новый клиент: FYSM (йога, СПб, инд. онлайн-занятия)
- Заведён проект `projects/FYSM/` (`context.md`/`voice.md`/`overrides.md`) из заявки
  survey.bitandpix.ru (ID 2460894795)
- Клиент дал список «коллег по цеху» — на деле это тренеры одной методики/бренда
  FYSM (trushinshow — продюсер FYSM, harevika/vladzarya/gonza.www — тренеры сети
  в разных городах). Полезный паттерн: такие списки стоит сначала гуглить, а не
  сразу считать конкурентами — меняет весь подход к аналитике
- Analytics-пайплайн (Apify профильный скрейп 7 акк. → отбор 3 → 40 reels/акк. →
  ratio → топ-10 → авто-топ-5 → fal.ai `openrouter/router/video` анализ) — прогнан
  агентом `analytics` полностью автономно, без пауз на подтверждение (по запросу
  оператора). Отчёт — `projects/FYSM/analytics/reels-2026-07-01.md`
- Сценарий Reels #1 (`posts/drafts/01_07_2026-reels-1/scenario.html`+`.pdf`) —
  адаптация референса @gonza.www (сторителлинг + демо асан через видеозвонок с
  тренером), но с юмором вместо драмы под тон бренда (лайфстайл+развлекательный+
  чуть экспертности)
- Формат папки использован `{dd_mm_yyyy}-reels-{N}` (дефис, не подчёркивание внутри
  даты — как в `global/rules.md`), не `{yyyy-mm-dd}` как было у academyfiz днём
  ранее — расхождение в прошлой сессии, для новых проектов ориентируемся на
  `global/rules.md`

---

## 2026-07-01 — Новый клиент: academyfiz (тренер по бегу, Челябинск)
- Заведён проект `projects/academyfiz/` с `context.md`
- Отработан новый workflow: Apify-парсинг конкурентов (3 аккаунта, 120 reels) → топ-10 по ratio → анализ 5 видео через fal.ai `openrouter/router/video` (Gemini 2.5 Flash) → PDF-сценарий
- Сценарий Reels #1 (`scenario.html` / `scenario.pdf`) — говорящая голова, хук «Почему в 35+ не получается начать бегать», без музыки (ключевой инсайт из анализа конкурентов)
- Модель для видеоанализа: `openrouter/router/video` (не `fal-ai/any-llm/vision`) — видео через `video_urls: [url]` + `model: "google/gemini-2.5-flash"`
...
- **Две общие памяти в git** (формат MEMORY.md-индекс + файлы по факту), читаются
  явным шагом в начале сессии:
  - `global/memory/` — **память оператора** (грабли платформ, «так принято»).
...
- **Клиентское знание — без изменений**: `projects/{ID}/overrides.md` /
  `feedback/`. Теперь Claude **обязан называть точный путь**, куда сохранил
  правило, — чтобы оператор сразу поймал мисроут. Правило — `global/rules.md` →
  «Фиксация правок клиента».
- Почистили старый OpenClaw/LiteLLM-хлам и протухшие IP/ссылки в памяти.

Оператору: на «запомни» Claude должен показать путь к файлу в репо. Если он
говорит «сохранил в память» без пути в репо — это баг, скажите разработчику.

---

## 2026-06-25 — Память правок клиента + строгая финализация логов
Две вещи, чтобы перестать терять знания и логи:

**1. Свод правок клиента.** Каждая правка клиента/оператора, которая действует
ВСЕГДА («шрифт на всех слайдах одинаковый», «тег канала мелким»), теперь
обязательно поднимается в секцию **«Накопленные правила»** в
`projects/{ID}/overrides.md`. Claude предлагает записать сам — ждать «запомни»
не надо. `overrides.md` читается при каждом старте, так что свод реально
подгружается в следующую сессию. Разовый разбор конкретного поста — по-прежнему
в `feedback/`. Правило — `global/rules.md` → «Фиксация правок клиента».

**2. Финализация логов — теперь Claude спрашивает сам.** Раньше логи сессий
