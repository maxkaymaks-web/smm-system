...
- **Egress-прокси (АКТУАЛЬНО с 2026-07-03): загранбокс `5.255.105.123`** (`vps18420745`),
  **3proxy** (user `egress`), SOCKS5 `:1080` + HTTP `:8888`, SSH `24822`. Крутит и `litellm-proxy`.
  Legacy tinyproxy endpoint из старых документов выведен из эксплуатации; актуальный адрес и порты указаны строкой выше.
...
egress к Telegram — только через аутентиф. 3proxy `5.255.105.123:8888`**
